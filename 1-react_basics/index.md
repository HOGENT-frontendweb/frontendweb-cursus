...
Hier voegen we hard gecodeerde tekst toe want weten of een lege component correct gerendered wordt is nogal lastig.
...
Verwijder alle code uit deze component en vervang dit door de `Transaction` component. We maken ook geen gebuik meer van het CSS bestand. Verder in dit hoofdstuk voegen we voor de opmaak Bootstrap toe.
